...
//     float thrust_left = 1.5;
//     float thrust_right = 1.7;
//     char buffer[20];
//         while (running) {
//         rhdSync();
...
int main(int argc, char * argv[]) {
    ...
    setpoint setpointList[] = {
        {.angle_setpoint = -2.5, .speed_setpoint = 2.5, .distance_setpoint = 14.5},
        {.angle_setpoint = 90.0, .speed_setpoint = 0.0, .distance_setpoint = -1},
        {.angle_setpoint = 90.0, .speed_setpoint = 2.5, .distance_setpoint = 3.8},
        {.angle_setpoint = 178.0, .speed_setpoint = 0.0, .distance_setpoint = -1},
        {.angle_setpoint = 178.0, .speed_setpoint = 2.5, .distance_setpoint = 9.0},
        {.angle_setpoint = 270.0, .speed_setpoint = 0.0, .distance_setpoint = -1},
        {.angle_setpoint = 270.0, .speed_setpoint = 2.5, .distance_setpoint = 3.0},
        {.angle_setpoint = 358.0, .speed_setpoint = 0.0, .distance_setpoint = -1},
...
void mission(setpoint setpoint, bool hasLogging, FILE* logFile) {
    ...
    float Kp_theta = 1.1, Kp_thetadot = 0.2, Kp_speed = 1.5;
